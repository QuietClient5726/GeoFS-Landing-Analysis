// ==UserScript==
// @name         GeoFS Landing Analysis Plugin
// @namespace    https://github.com/QuietClient5726/GeoFS-Landing-Analysis/blob/main/README.md
// @version      2024-08-05
// @description  Used to display landing information after landing in GeoFS.
// @author       QuietClient5725
...
setTimeout((function() {
    ...
    window.closeTimer = 5; //Set to true if you want a timer to close the landing stats. Set to false if you want to manually close the landing stats.
    window.closeSeconds = 5; //Number of seconds to wait before closing the landing stats.
    ...
    window.statsDiv.style.background = 'rgb(87, 77, 100)';
    ...
    window.statsDiv.style.color = 'red';
